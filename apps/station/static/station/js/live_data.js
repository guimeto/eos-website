...
function displayStationCurrentData(data) {
    ...
    table.classList.add("col-lg-4");
    table.classList.add("col-md-12");
    addRow(table.insertRow(), `Temperature (${data.elev1}m)`,  `${data.Temp1_Avg} °C`);
    addRow(table.insertRow(), `Temperature (${data.elev2}m)`, `${data.Temp2_Avg} °C`);
    addRow(table.insertRow(), `Temperature (${data.elev3}m)`, `${data.Temp3_Avg} °C`);
    addRow(table.insertRow(), `Temperature (${data.elev4}m)`, `${data.Temp4_Avg} °C`);
    addRow(table.insertRow(), `Temperature (${data.elev5}m)`, `${data.Temp5_Avg} °C`);
    addRow(table.insertRow(), `Temperature (${data.elev6}m)`, `${data.Temp6_Avg} °C`);
    addRow(table.insertRow(), `Temperature (${data.elev7}m)`, `${data.Temp7_Avg} °C`);
    addRow(table.insertRow(), `Temperature (${data.elev8}m)`, `${data.Temp8_Avg} °C`);
    addRow(table.insertRow(), `Relative humidity (${data.elev1}m)`, `${data.RH1} %`);
    addRow(table.insertRow(), `Relative humidity (${data.elev2}m)`, `${data.RH2} %`);
    addRow(table.insertRow(), `Relative humidity (${data.elev3}m)`, `${data.RH3} %`);
    addRow(table.insertRow(), `Relative humidity (${data.elev4}m)`, `${data.RH4} %`);
    addRow(table.insertRow(), `Relative humidity (${data.elev5}m)`, `${data.RH5} %`);
    addRow(table.insertRow(), `Relative humidity (${data.elev6}m)`, `${data.RH6} %`);
    addRow(table.insertRow(), `Relative humidity (${data.elev7}m)`, `${data.RH7} %`);
    addRow(table.insertRow(), `Relative humidity (${data.elev8}m)`, `${data.RH8} %`);
    div.appendChild(table);
